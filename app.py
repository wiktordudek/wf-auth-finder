...
def find_game_process() -> psutil.Process:
...
def read_memory_value(process_pid: int, pattern: str, length: int) -> bytes:
    ...
    return MemoryValueNotFoundError(pattern)
...
if __name__ == "__main__":
    ...
    except MemoryValueNotFoundError as exception:
        logger.error(f"❌ Couldn't find the {exception.pattern} value.")
    except Exception:
